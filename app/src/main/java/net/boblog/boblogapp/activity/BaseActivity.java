...
//                    | View.SYSTEM_UI_FLAG_LAYOUT_STABLE);
            ...
            getWindow().getDecorView().setPadding(0, UiTools.getStatusBarHeight(this), 0, 0);
            getWindow().getDecorView().setBackgroundColor(getResources().getColor(R.color.color_top_bar));
        }
    }
